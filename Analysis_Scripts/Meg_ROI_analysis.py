...
X_source, y = preprocess_source_space_data('0085', '20221004_000000',
        raw_path='../../220269/raw_MEG/', 
        subjects_dir='../../220269/freesurfer/',
        epochs_list=epochs_list) ##CHANGE TO YOUR PATHS

X_fusiform_lh, y = preprocess_source_space_data('0085',
                                                      '20221004_000000',
        raw_path='../../220269/raw_MEG/', 
        subjects_dir='../../220269/freesurfer/',
        label= 'lh.fusiform.label', epochs_list=epochs_list)
        
X_fusiform_rh, y = preprocess_source_space_data('0085',
                                                      '20221004_000000',
        raw_path='../../220269/raw_MEG/',  
        subjects_dir='../../220269/freesurfer/',
        label='rh.fusiform.label', epochs_list=epochs_list)
...
mean_scores_fusiform_both = simple_classication(X_fusiform_both,
                                   collapsed_y,
                                   penalty='l2', C=1e-3)
...
#mean_scores_LO_both = simple_classication(X_fusiform_both,
#                                  collapsed_y,
#                                  penalty='l2', C=1e-3)
...
plot_classfication(epochs_list[0].times, mean_scores_fusiform_both)